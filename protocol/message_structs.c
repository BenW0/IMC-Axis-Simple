...
const uint8_t imc_message_type_count = 7;    // number of message types defined.

const uint8_t imc_message_length[8] = {0, sizeof(msg_initialize_t), 
                              0/*sizeof(msg_status_t)*/, 0/*sizeof(msg_home_t)*/, sizeof(msg_queue_move_t), 
                              sizeof(msg_get_param_t), sizeof(msg_set_param_t), 0};

const uint8_t imc_resp_length[8] = {0, sizeof(rsp_initialize_t), 
